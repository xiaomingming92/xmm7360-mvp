...
| 指标 | 白天那场风暴（20:26–20:57） | 第三轮演练（22:54–23:00，比真实故障更狠：强制重载模块） |
|---|---|---|
| 触发恢复 | 14 次 | 3 次（其中 2 次被正确去抖/让路） |
| bring-up 次数 | 29 次 | 6 次（硬恢复首跑 1 + 常规阶梯 3，第 3 次 3 秒成功） |
| 恢复耗时 | 31 分 18 秒 | 5 分 54 秒（装上卡死看门狗后预计 ≈2.5 分钟） |
| 需要人工 | 否 | 否 |
